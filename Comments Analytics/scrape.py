...
class App:
    ...
    def naviagte_posts(self):
        ...
        for i in range(420,len(unique_post)):
            ...
            self.get_data()
            if (i+1)% 10 == 0:
                self.write_captions_to_excel_file((i+1)//10)
        sleep(10)
