        ...
        for i in range(1,3001):
            ...
            for link in profile_links:
                ...
                for i in range(20):
                    ...
                    sleep(1)
                sleep(2)
                dates= self.driver.find_elements_by_xpath('//section[@id="education-section"]//p[@class="pv-entity__dates t-14 t-black--light t-normal"]/span[2]/time')
                dates= [date.get_attribute('textContent') for date in dates]
                sleep(2)
                print(dates)
