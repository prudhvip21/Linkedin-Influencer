...
class App:
    ...
    def send_msg(self):
        ...
        i=1
        for link in links:
            print(f"Sending message {i} out of {len(links)}.....")
            ...
            try:
                ...
                sleep(3)
                self.driver.find_element_by_xpath('//div[@class="msg-form__contenteditable t-14 t-black--light t-normal flex-grow-1 notranslate"]').send_keys("Thanks a lot for supporting us. Here is the bundle you have requested for")
                ...
                sleep(5)
                self.driver.find_element_by_xpath('//div[@class="msg-form__contenteditable t-14 t-black--light t-normal flex-grow-1 notranslate"]').send_keys("https://www.supervisedlearning.com/course/freedombundle")
                sleep(2)
                self.driver.find_element_by_xpath('//div[@class="msg-form__contenteditable t-14 t-black--light t-normal flex-grow-1 notranslate"]').send_keys(Keys.ENTER)
                sleep(2)
                self.driver.find_element_by_xpath('//div[@class="msg-form__contenteditable t-14 t-black--light t-normal flex-grow-1 notranslate"]').send_keys("Click the link and register. Post registration, click view content and enjoy.")
                sleep(2)
                self.driver.find_element_by_xpath('//div[@class="msg-form__contenteditable t-14 t-black--light t-normal flex-grow-1 notranslate"]').send_keys(Keys.ENTER)
                sleep(3)
            except Exception:
